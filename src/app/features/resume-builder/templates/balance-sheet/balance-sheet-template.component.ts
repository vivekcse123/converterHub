...
@Component({
  selector: 'app-balance-sheet-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './balance-sheet-template.component.html',
  styleUrls: ['../shared/print.css', './balance-sheet-template.component.css'],
})
export class BalanceSheetTemplateComponent {
