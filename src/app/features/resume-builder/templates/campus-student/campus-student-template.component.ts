...
@Component({
  selector: 'app-campus-student-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './campus-student-template.component.html',
  styleUrls: ['../shared/print.css', './campus-student-template.component.css'],
})
export class CampusStudentTemplateComponent {
