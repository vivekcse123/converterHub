...
@Component({
  selector: 'app-dark-luxury-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './dark-luxury-template.component.html',
  styleUrls: ['../shared/print.css', './dark-luxury-template.component.css'],
})
export class DarkLuxuryTemplateComponent {
