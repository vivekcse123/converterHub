...
@Component({
  selector: 'app-corporate-formal-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './corporate-formal-template.component.html',
  styleUrls: ['../shared/print.css', './corporate-formal-template.component.css'],
})
export class CorporateFormalTemplateComponent {
