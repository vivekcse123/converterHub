...
export class HomeComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  readonly products = [
    ...
    { icon: '🌐', iconBg: 'bg-indigo-100 dark:bg-indigo-900/40',  title: 'Portfolio Builder',      desc: 'Shareable online portfolio with a unique live URL',                   route: '/portfolio',    badge: 'Pro',  badgeClass: 'bg-primary-100 dark:bg-primary-900/40 text-primary-700 dark:text-primary-300' },
