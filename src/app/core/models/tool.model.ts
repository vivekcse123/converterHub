...
export type ToolCategory = 'pdf' | 'image' | 'document' | 'archive' | 'ai';
...
export const TOOLS: Tool[] = [
  ...
  // ── AI tools ─────────────────────────────────────────────────────────────────
  { id: 'ai-chat',          title: 'Chat with PDF',      description: 'Ask questions about any PDF using AI and get instant answers.',              icon: '🤖',  route: '/ai/chat',          category: 'ai',       acceptedFormats: ['.pdf'],                  outputFormat: 'Text',   color: 'from-violet-600 to-purple-700',  badge: 'AI' },
  { id: 'ai-summarize',     title: 'AI Summarize',       description: 'Generate a concise AI-powered summary of any PDF document.',                icon: '✨',  route: '/ai/summarize',     category: 'ai',       acceptedFormats: ['.pdf'],                  outputFormat: 'Text',   color: 'from-indigo-600 to-blue-700',    badge: 'AI' },
  { id: 'ai-keywords',      title: 'AI Keywords',        description: 'Automatically extract the most relevant keywords and topics from a PDF.',   icon: '🏷️',  route: '/ai/keywords',      category: 'ai',       acceptedFormats: ['.pdf'],                  outputFormat: 'Tags',   color: 'from-pink-600 to-rose-700',      badge: 'AI' },
];
