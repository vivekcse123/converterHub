...
export const TOOLS: Tool[] = [
  ...
  { id: 'resume-builder',   title: 'Resume Builder',     description: 'Build a professional, ATS-friendly resume with live preview and free PDF download.', icon: '🧑‍💼', route: '/resume-builder',   category: 'resume',   acceptedFormats: [],                        outputFormat: 'PDF',    color: 'from-primary-500 to-indigo-600',   badge: 'Popular', weight: 110 },
  { id: 'portfolio-builder', title: 'Portfolio Builder', description: 'Create a public portfolio page with your bio, skills, projects, and social links - shareable in seconds.', icon: '🌐', route: '/portfolio', category: 'resume', acceptedFormats: [], outputFormat: 'Page', color: 'from-indigo-500 to-primary-600', badge: 'Pro', weight: 109 },
  { id: 'cover-letter',     title: 'Cover Letter',       description: 'Generate a professional cover letter from your resume in seconds. Three tone options - copy or download.', icon: '✉️', route: '/resume-builder/cover-letter', category: 'resume', acceptedFormats: [], outputFormat: 'TXT', color: 'from-emerald-500 to-teal-600', badge: 'Pro', weight: 107 },
  ...
  { id: 'ats-checker',      title: 'ATS Resume Checker', description: 'Real AI-powered deep analysis of your resume — grammar, achievements, and ATS compatibility, section-scored with exact fixes.', icon: '🎯', route: '/ats-resume-checker', category: 'resume', acceptedFormats: ['.pdf','.docx','.txt'], outputFormat: 'Report', color: 'from-emerald-500 to-teal-600', badge: 'New', weight: 106 },

  // ── Original PDF tools ───────────────────────────────────────────────────────
  { id: 'bg-remover',       title: 'Background Remover', description: 'Remove the background from any photo in one click, then swap in a color, gradient, or your own image.', icon: '✂️', route: '/background-remover', category: 'image', acceptedFormats: ['.jpg','.png','.webp','.gif'], outputFormat: 'PNG', color: 'from-violet-600 to-fuchsia-500', badge: 'Popular', weight: 105 },
  ...
  { id: 'pdf-to-word',      title: 'PDF to Word',        description: 'Extract content from a PDF and save it as an editable .docx file.',          icon: '📄',  route: '/pdf-to-word',      category: 'document', acceptedFormats: ['.pdf'],                  outputFormat: 'DOCX',   color: 'from-primary-500 to-purple-600', weight: 90 },
  ...
  { id: 'sign-pdf',         title: 'Sign PDF',           description: 'Place a signature image on any page of your PDF document.',                  icon: '✍️',  route: '/sign-pdf',         category: 'pdf',      acceptedFormats: ['.pdf'],                  outputFormat: 'PDF',    color: 'from-primary-500 to-indigo-600',   badge: 'New', weight: 50 },
  ...
  { id: 'organize-pdf',     title: 'Organize PDF',       description: 'Reorder or delete specific pages from your PDF document.',                   icon: '📑',  route: '/organize-pdf',     category: 'pdf',      acceptedFormats: ['.pdf'],                  outputFormat: 'PDF',    color: 'from-purple-500 to-primary-600',  badge: 'New', weight: 66 },
  ...
  { id: 'pdf-to-epub',      title: 'PDF to EPUB',        description: 'Convert a PDF into an eBook (EPUB) for Kindle and e-readers.',              icon: '📚',  route: '/pdf-to-epub',      category: 'document', acceptedFormats: ['.pdf'],                  outputFormat: 'EPUB',   color: 'from-purple-400 to-primary-500', badge: 'New', weight: 22 },
