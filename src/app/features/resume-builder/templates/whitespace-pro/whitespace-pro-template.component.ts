...
@Component({
  selector: 'app-whitespace-pro-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './whitespace-pro-template.component.html',
  styleUrls: ['../shared/print.css', './whitespace-pro-template.component.css'],
})
export class WhitespaceProTemplateComponent {
