...
@Component({
  selector: 'app-data-notebook-sidebar-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './data-notebook-sidebar-template.component.html',
  styleUrls: ['../shared/print.css', './data-notebook-sidebar-template.component.css'],
})
export class DataNotebookSidebarTemplateComponent {
