...
@Component({
  selector: 'app-elegant-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './elegant-template.component.html',
  styleUrls: ['../shared/print.css', './elegant-template.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ElegantTemplateComponent {
