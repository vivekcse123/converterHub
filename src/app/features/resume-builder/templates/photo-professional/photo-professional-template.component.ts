...
@Component({
  selector: 'app-photo-professional-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './photo-professional-template.component.html',
  styleUrls: ['../shared/print.css', './photo-professional-template.component.css'],
})
export class PhotoProfessionalTemplateComponent {
