...
@Component({
  selector: 'app-executive-serif-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './executive-serif-template.component.html',
  styleUrls: ['../shared/print.css', './executive-serif-template.component.css'],
})
export class ExecutiveSerifTemplateComponent {
