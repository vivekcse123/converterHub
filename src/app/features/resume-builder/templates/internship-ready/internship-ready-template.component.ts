...
@Component({
  selector: 'app-internship-ready-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './internship-ready-template.component.html',
  styleUrls: ['../shared/print.css', './internship-ready-template.component.css'],
})
export class InternshipReadyTemplateComponent {
