...
@Component({
  selector: 'app-centered-cv-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './centered-cv-template.component.html',
  styleUrls: ['../shared/print.css', './centered-cv-template.component.css'],
})
export class CenteredCvTemplateComponent {
