...
export const routes: Routes = [
  // ── Home ────────────────────────────────────────────────────────────────────
  {
    ...
    title: 'ApnaConverter: Resume Builder, ATS Checker, Biodata & Career Tools',
    data: { description: 'Create ATS-friendly resumes, biodata, cover letters, and portfolios with ApnaConverter. Professional templates, AI-powered tools, and instant PDF downloads. Plus 40+ free file converter tools.' },
  },
  ...
  // ── Tools directory ─────────────────────────────────────────────────────────
  {
    ...
    title: 'All Tools | ApnaConverter',
    data: { description: 'Browse 37+ free online tools: PDF converters, image editors, resume builder, biodata maker and more. No sign-up required.' },
  },
  ...
  { path: 'portfolio', loadChildren: () => import('./features/portfolio-builder/portfolio-builder.routes').then(m => m.portfolioBuilderRoutes) },
  {
    ...
    title: 'Resume Templates, Biodata Templates & CV Designs | ApnaConverter',
    data: { description: 'Browse 30+ ATS-friendly resume templates with live previews. Free and premium designs for every role. Pick one and build your resume online for free.' },
  },
  {
    path: 'resume-templates/:slug',
    loadComponent: () => import('./features/resume-builder/pages/template-detail/template-detail.component').then(m => m.TemplateDetailComponent),
    title: 'Resume Template | ApnaConverter',
    data: { description: 'View a full interactive preview of this ATS-friendly resume template. Switch sample profiles, zoom in, and start building your resume for free.' },
  },
  {
  ...
  // ── SEO Landing Pages ────────────────────────────────────────────────────────
  {
    ...
    title: 'Free ATS Resume Checker & Score Analyzer | ApnaConverter',
  ...
  },
  {
    ...
    title: 'Free Fresher Resume Builder & Templates | ApnaConverter',
    data: { description: 'Create a professional fresher resume with ATS-friendly templates. Highlight education, projects, and skills. Free PDF download, no sign-up required.' },
  },
  {
  ...
  },
  {
    ...
    title: 'Government Resume Builder for SSC, Banking & Railway Jobs | ApnaConverter',
    data: { description: 'Create a government job resume in the correct official format for SSC, UPSC, State PSC, Banking, Railways. Passport photo support, declaration section, free PDF download.' },
  },
  ...
  { path: 'refund-policy',  loadComponent: () => import('./features/refund-policy/refund-policy.component').then(m => m.RefundPolicyComponent),   title: 'Refund Policy | ApnaConverter', data: { description: 'ApnaConverter refund policy for Pro subscriptions and premium template purchases. Learn how to request a refund and our eligibility windows.' } },
