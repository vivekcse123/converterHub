...
@Component({
  selector: 'app-ux-flow-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './ux-flow-template.component.html',
  styleUrls: ['../shared/print.css', './ux-flow-template.component.css'],
})
export class UxFlowTemplateComponent {
