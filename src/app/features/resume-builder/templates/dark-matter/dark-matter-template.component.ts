...
@Component({
  selector: 'app-dark-matter-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './dark-matter-template.component.html',
  styleUrls: ['../shared/print.css', './dark-matter-template.component.css'],
})
export class DarkMatterTemplateComponent {
