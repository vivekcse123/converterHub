...
@Component({
  selector: 'app-bold-statement-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './bold-statement-template.component.html',
  styleUrls: ['../shared/print.css', './bold-statement-template.component.css'],
})
export class BoldStatementTemplateComponent {
