...
@Component({
  selector: 'app-grotesk-bold-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './grotesk-bold-template.component.html',
  styleUrls: ['../shared/print.css', './grotesk-bold-template.component.css'],
})
export class GroteskBoldTemplateComponent {
