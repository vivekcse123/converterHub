...
@Component({
  selector: 'app-header-split-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './header-split-template.component.html',
  styleUrls: ['../shared/print.css', './header-split-template.component.css'],
})
export class HeaderSplitTemplateComponent {
