...
@Component({
  selector: 'app-executive-minimal-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './executive-minimal-template.component.html',
  styleUrls: ['../shared/print.css', './executive-minimal-template.component.css'],
})
export class ExecutiveMinimalTemplateComponent {
