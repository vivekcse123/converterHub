...
@Component({
  selector: 'app-gradient-header-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './gradient-header-template.component.html',
  styleUrls: ['../shared/print.css', './gradient-header-template.component.css'],
})
export class GradientHeaderTemplateComponent {
