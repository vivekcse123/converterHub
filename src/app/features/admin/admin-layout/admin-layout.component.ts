    ...
    <div class="min-h-screen bg-slate-50 dark:bg-slate-900">
      ...
      <header class="lg:hidden flex items-center justify-between bg-slate-900 text-white px-4 py-3 sticky top-0 z-40">
        <span class="flex items-center gap-2 text-lg font-bold">
          <img src="assets/favicon-96x96.png" alt="logo" class="w-7 h-7 rounded-lg object-contain">
          Admin Panel
        </span>
      ...
      <div class="flex">
        ...
        <aside [class]="sidebarOpen() ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'"
          ...
          <div class="hidden lg:flex items-center gap-3 px-6 py-5 border-b border-slate-700">
            <img src="assets/favicon-96x96.png" alt="ApnaConverter logo" class="w-8 h-8 rounded-lg object-contain">
