...
@Component({
  selector: 'app-boxed-cv-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './boxed-cv-template.component.html',
  styleUrls: ['../shared/print.css', './boxed-cv-template.component.css'],
})
export class BoxedCvTemplateComponent {
