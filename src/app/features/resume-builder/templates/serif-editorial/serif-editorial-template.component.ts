...
@Component({
  selector: 'app-serif-editorial-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './serif-editorial-template.component.html',
  styleUrls: ['../shared/print.css', './serif-editorial-template.component.css'],
})
export class SerifEditorialTemplateComponent {
