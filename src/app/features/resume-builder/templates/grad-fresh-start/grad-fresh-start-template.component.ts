...
@Component({
  selector: 'app-grad-fresh-start-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './grad-fresh-start-template.component.html',
  styleUrls: ['../shared/print.css', './grad-fresh-start-template.component.css'],
})
export class GradFreshStartTemplateComponent {
