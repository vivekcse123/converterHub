...
@Component({
  selector: 'app-academic-scholar-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './academic-scholar-template.component.html',
  styleUrls: ['../shared/print.css', './academic-scholar-template.component.css'],
})
export class AcademicScholarTemplateComponent {
