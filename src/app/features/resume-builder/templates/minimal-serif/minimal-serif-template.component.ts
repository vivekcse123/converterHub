...
@Component({
  selector: 'app-minimal-serif-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './minimal-serif-template.component.html',
  styleUrls: ['../shared/print.css', './minimal-serif-template.component.css'],
})
export class MinimalSerifTemplateComponent {
