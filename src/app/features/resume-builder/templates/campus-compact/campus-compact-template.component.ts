...
@Component({
  selector: 'app-campus-compact-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './campus-compact-template.component.html',
  styleUrls: ['../shared/print.css', './campus-compact-template.component.css'],
})
export class CampusCompactTemplateComponent {
