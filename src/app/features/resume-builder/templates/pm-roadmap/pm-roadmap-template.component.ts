...
@Component({
  selector: 'app-pm-roadmap-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './pm-roadmap-template.component.html',
  styleUrls: ['../shared/print.css', './pm-roadmap-template.component.css'],
})
export class PmRoadmapTemplateComponent {
