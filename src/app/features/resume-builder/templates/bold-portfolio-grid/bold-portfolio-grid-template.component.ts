...
@Component({
  selector: 'app-bold-portfolio-grid-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './bold-portfolio-grid-template.component.html',
  styleUrls: ['../shared/print.css', './bold-portfolio-grid-template.component.css'],
})
export class BoldPortfolioGridTemplateComponent {
