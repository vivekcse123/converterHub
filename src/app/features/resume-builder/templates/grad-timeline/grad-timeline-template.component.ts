...
@Component({
  selector: 'app-grad-timeline-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './grad-timeline-template.component.html',
  styleUrls: ['../shared/print.css', './grad-timeline-template.component.css'],
})
export class GradTimelineTemplateComponent {
