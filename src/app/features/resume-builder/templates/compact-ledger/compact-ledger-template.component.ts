...
@Component({
  selector: 'app-compact-ledger-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './compact-ledger-template.component.html',
  styleUrls: ['../shared/print.css', './compact-ledger-template.component.css'],
})
export class CompactLedgerTemplateComponent {
