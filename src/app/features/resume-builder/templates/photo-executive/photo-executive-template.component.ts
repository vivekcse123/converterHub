...
@Component({
  selector: 'app-photo-executive-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './photo-executive-template.component.html',
  styleUrls: ['../shared/print.css', './photo-executive-template.component.css'],
})
export class PhotoExecutiveTemplateComponent {
