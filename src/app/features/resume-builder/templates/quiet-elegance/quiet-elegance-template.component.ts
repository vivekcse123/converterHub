...
@Component({
  selector: 'app-quiet-elegance-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './quiet-elegance-template.component.html',
  styleUrls: ['../shared/print.css', './quiet-elegance-template.component.css'],
})
export class QuietEleganceTemplateComponent {
