...
export const TOOLS: Tool[] = [
  ...
  { id: 'portfolio-builder', title: 'Portfolio Builder', description: 'Create a public portfolio page with your bio, skills, projects, and social links - shareable in seconds.', icon: '🌐', route: '/resume-builder/portfolio', category: 'resume', acceptedFormats: [], outputFormat: 'Page', color: 'from-indigo-500 to-primary-600', badge: 'Pro', weight: 109 },
