...
@Component({
  selector: 'app-photo-teacher-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './photo-teacher-template.component.html',
  styleUrls: ['../shared/print.css', './photo-teacher-template.component.css'],
})
export class PhotoTeacherTemplateComponent {
