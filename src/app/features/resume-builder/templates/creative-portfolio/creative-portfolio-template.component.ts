...
@Component({
  selector: 'app-creative-portfolio-template',
  standalone: true,
  imports: [CommonModule, RichTextComponent],
  templateUrl: './creative-portfolio-template.component.html',
  styleUrls: ['../shared/print.css', './creative-portfolio-template.component.css'],
})
export class CreativePortfolioTemplateComponent {
